...
export const kavramlarTopics: ContentTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "kav-on", label: "Ön", speech: "ön", lang: "tr", emoji: "👉" },
      { id: "kav-arka", label: "Arka", speech: "arka", lang: "tr", emoji: "👈" },
      { id: "kav-sag", label: "Sağ", speech: "sağ", lang: "tr", emoji: "➡️" },
      { id: "kav-sol", label: "Sol", speech: "sol", lang: "tr", emoji: "⬅️" },
    ],
  },
  {
    id: "zit-anlamli",
    ...
    ages: [5, 6],
    items: [
      { id: "zit-sicak", label: "Sıcak", speech: "sıcak", lang: "tr", emoji: "🔥" },
      { id: "zit-soguk", label: "Soğuk", speech: "soğuk", lang: "tr", emoji: "🧊" },
      { id: "zit-acik", label: "Açık", speech: "açık", lang: "tr", emoji: "🚪" },
      { id: "zit-kapali", label: "Kapalı", speech: "kapalı", lang: "tr", emoji: "🔒" },
      { id: "zit-hizli", label: "Hızlı", speech: "hızlı", lang: "tr", emoji: "🐆" },
